-- Supprimer tous les triggers et la fonction en cascade
DROP FUNCTION IF EXISTS public.update_user_progress_on_score() CASCADE;

-- Créer une fonction simple pour calculer les statistiques
